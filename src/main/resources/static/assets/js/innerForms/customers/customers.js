function details(element) {
    ...
    if (element.type === "OOO") {
        innerBlock.append('<div class="card animate__animated animate__fadeIn animate__fast">' +
            ...
            '                                <form action="/customer/save/' + element.id + '" method="post">' +
            '                                    <h5 class="card-title text-center border-top"><br>Основная информация<br></h5>' +

            '                                    <input type="text" modelAttribute="enterprise" name="subType" value="CUSTOMER" style="display: none">' +
            ...
            '                                   <form action="/customer/remove/' + element.id + '" method="post">' +
    ...
    else if (element.type === "PRIVATE_PERSON") {
        innerBlock.append('<div class="card animate__animated animate__fadeIn animate__fast">' +
            '                            <div class="card-body">' +
            '                                <h4 class="card-title">Карточка заказчика: ' + element.name + '</h4>' +
            '                                <form action="/customer/save/' + element.id + '" method="post">' +
            ...
            '                                    <input type="text" modelAttribute="enterprise" name="subType" value="CUSTOMER" style="display: none">' +
            '                                    <input type="text" modelAttribute="enterprise" name="type" value="PRIVATE_PERSON" style="display: none">' +
            '                                    <input type="text" modelAttribute="enterprise" name="name" value="Частное лицо" style="display: none">' +
            '                                    <input type="text" modelAttribute="enterprise" name="id" value="' + element.id + '" text="' + element.id + '" style="display: none">' +
            '                                    <input type="text" modelAttribute="requisites" style="display: none">' +
...
function showOoo() {
    ...
    innerBlock.append(
        ...
        '                                    <form id="form-input" action="/customer/add" method="post">' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Тип организации</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">' +
        '                                                    <label class="btn btn-primary active">' +
        '                                                        <input type="radio" modelAttribute="enterprise" name="type" value="OOO" id="radioOoo" checked="" onclick="showOoo()"> ООО' +
        '                                                    </label>' +
        '                                                    <label class="btn btn-primary">' +
        '                                                        <input type="radio" modelAttribute="enterprise" name="type" value="IP" id="radioIp" onclick="showIp()"> ИП' +
        '                                                    </label>' +
        '                                                    <label class="btn btn-primary">' +
        '                                                        <input type="radio" modelAttribute="enterprise" name="type" value="PRIVATE_PERSON" id="radioCHL" onclick="showPp()"> Частное лицо' +
        '                                                    </label>' +
        '                                                </div>' +
        '                                            </div>' +
        '                                        </div>' +
        ...
        '                                        <input type="text" modelAttribute="enterprise" name="subType" value="CUSTOMER" class="form-control" style="display: none">' +
        '                                        <input type="text" modelAttribute="passport" style="display: none">' +
...
function showIp() {
    ...
    innerBlock.append(
        ...
        '                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">' +
        '                                                    <label class="btn btn-primary">' +
        '                                                        <input type="radio" modelAttribute="enterprise" name="type" value="OOO" id="radioOoo" onclick="showOoo()"> ООО' +
        '                                                    </label>' +
        '                                                    <label class="btn btn-primary active">' +
...
function showPp() {
    ...
    innerBlock.append(
        ...
        '                                                    </label>' +
        '                                                    <label class="btn btn-primary active">' +
        '                                                        <input type="radio" modelAttribute="enterprise" name="type" value="PRIVATE_PERSON" id="radioCHL" checked="" onclick="showPp()"> Частное лицо' +
        '                                                    </label>' +
        '                                                </div>' +
        '                                            </div>' +
        '                                        </div>' +
        ...
        '                                            <label class="col-sm-3 col-form-label">Фамилия</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="lastName" class="form-control" placeholder="Фамилия" required="">' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Имя</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="firstName" class="form-control" placeholder="Имя" required="">' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Отчество</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="patronymic" class="form-control" placeholder="Отчество" required="">' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Серия паспорта</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input id="serialPassport" type="text" modelAttribute="enterprise" name="serialPassport" class="form-control" placeholder="Серия паспорта" required="">' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Номер паспорта</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input id="numberPassport" type="text" modelAttribute="enterprise" name="numberPassport" class="form-control" placeholder="Номер паспорта" required="">' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Кем выдан</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="issued" class="form-control" placeholder="Кем выдан" required="">' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Дата выдачи</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="date" modelAttribute="enterprise" name="issuedDate" class="form-control" placeholder="Дата выдачи" required="">' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Номер телефона</label>' +
