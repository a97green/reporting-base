function details(element) {
    ...
    if (element.typeOrganization === "ООО") {
        innerBlock.append('<div class="card animate__animated animate__fadeIn animate__fast">\n' +
            '                            <div class="card-body">\n' +
            '                                <h4 class="card-title">Карточка предприятия</h4>\n' +
            '                                <form action="/our-company/save/ooo/' + element.id + '" method="post">\n' +
            ...
            '                                        <div class="col-sm-9">\n' +
            '                                            <input id="inn" value="' + element.requisites.inn + '" text="' + element.requisites.inn + '" type="text" name="inn" class="form-control form-details" placeholder="ИНН" disabled>\n' +
            '                                        </div>\n' +
            '                                    </div>\n' +
            '                                    <div class="form-group row">\n' +
            '                                        <label class="col-sm-3 col-form-label">КПП</label>\n' +
            '                                        <div class="col-sm-9">\n' +
            '                                            <input id="kpp" value="' + element.requisites.kpp + '" text="' + element.requisites.kpp + '" type="text" name="kpp" class="form-control form-details" placeholder="КПП" disabled>\n' +
            '                                        </div>\n' +
            '                                    </div>\n' +
            '                                        <div class="form-group row">\n' +
            ...
            '                                   <form action="/our-company/remove/' + element.id + '" method="post">\n' +
        ...
        innerBlock.append('<div class="card animate__animated animate__fadeIn animate__fast">\n' +
            '                            <div class="card-body">\n' +
            '                                <h4 class="card-title">Карточка предприятия</h4>\n' +
            '                                <form action="/our-company/save/ip/' + element.id + '" method="post">\n' +
            '                                    <h5 class="card-title text-center border-top"><br>Основная информация<br></h5>\n' +
            '                                    <div class="form-group row">\n' +
            '                                        <label class="col-sm-3 col-form-label">Название организации</label>\n' +
            '                                        <div class="col-sm-9">\n' +
            ...
            '                                        <div class="col-sm-9">\n' +
            '                                            <input id="issued" value="' + element.passport.issued + '" text="' + element.passport.issued + '" type="text" name="issued" class="form-control form-details" placeholder="ОГРН" required disabled>\n' +
            '                                        </div>\n' +
            '                                    </div>\n' +                        '                                    <div class="form-group row">\n' +
            '                                        <label class="col-sm-3 col-form-label">Дата выдачи</label>\n' +
            '                                        <div class="col-sm-9">\n' +
            '                                            <input id="issuedDate" value="' + element.passport.issuedDate + '" text="' + element.passport.issuedDate + '" type="text" name="issuedDate" class="form-control form-details" placeholder="ОГРН" required disabled>\n' +
            '                                        </div>\n' +
            '                                    </div>\n' +
...
function showOoo() {
    ...
    innerBlock.append('<div class="card animate__animated animate__fadeIn animate__fast">\n' +
        ...
        '                                    <form id="form-input" action="/our-company/ooo" method="post">\n' +
        '\n' +
        '\n' +
        '                                        <div class="form-group row">\n' +
        ...
        '                                            <label class="col-sm-3 col-form-label">ИНН</label>\n' +
        '                                            <div class="col-sm-9">\n' +
        '                                                <input id="inn" type="text" name="inn" class="form-control" placeholder="ИНН">\n' +
        '                                            </div>\n' +
        '                                        </div>\n' +
        '                                        <div class="form-group row">\n' +
        '                                            <label class="col-sm-3 col-form-label">КПП</label>\n' +
        '                                            <div class="col-sm-9">\n' +
        '                                                <input id="kpp" type="text" name="kpp" class="form-control" placeholder="КПП">\n' +
        '                                            </div>\n' +
        '                                        </div>\n' +
        '                                        <div class="form-group row">\n' +
        '                                            <label class="col-sm-3 col-form-label">Расчётный счёт</label>\n' +
...
function showIp() {
    ...
    innerBlock.append('<div class="card animate__animated animate__fadeIn animate__fast">\n' +
        ...
        '                                    <h4 class="card-title">Новая компания</h4>\n' +
        '                                    <p class="card-title-desc">Добавьте новую компанию.</p>\n' +
        '                                    <form id="form-input" action="/our-company/ip" method="post">\n' +
        '                                        <div class="form-group row">\n' +
        '                                            <label class="col-sm-3 col-form-label">Тип организации</label>\n' +
        '                                            <div class="col-sm-9">\n' +
        '                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">\n' +
