function details(element) {
    ...
    if (element.type === "OOO") {
        innerBlock.append('<div class="card animate__animated animate__fadeIn animate__fast">' +
            ...
            '                                            <div class="col-sm-9">' +
            '                                                <input modelAttribute="enterprise" id="atiCode" value="' + element.atiCode + '" text="' + element.atiCode + '" type="text" name="atiCode" class="form-control form-details" placeholder="Код АТИ" required disabled>' +
            '                                            </div>' +
            '                                        </div>' +
        ...
        innerBlock.append('<div class="card animate__animated animate__fadeIn animate__fast">' +
            ...
            '                                            <label class="col-sm-3 col-form-label">Код АТИ</label>' +
            '                                            <div class="col-sm-9">' +
            '                                                <input id="atiCode" type="text" modelAttribute="enterprise" name="atiCode" value="' + element.atiCode + '" text="' + element.atiCode + '" class="form-control" placeholder="Код АТИ" required="">' +
            '                                            </div>' +
            '                                        </div>' +
            '                                    <h5 class="card-title text-center border-top"><br>Банковские реквизиты<br></h5>' +
            // '                                    <div class="form-group row">' +
