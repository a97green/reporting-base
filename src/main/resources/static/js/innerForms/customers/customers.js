...
function showPp() {
    ...
    innerBlock.append(
        ...
        '                                            <label class="col-sm-3 col-form-label">Фамилия</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="lastName" class="form-control" placeholder="Фамилия" >' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Имя</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="firstName" class="form-control" placeholder="Имя" >' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Отчество</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="patronymic" class="form-control" placeholder="Отчество" >' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Серия паспорта</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input id="serialPassport" type="text" modelAttribute="enterprise" name="serialPassport" class="form-control" placeholder="Серия паспорта" >' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Номер паспорта</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input id="numberPassport" type="text" modelAttribute="enterprise" name="numberPassport" class="form-control" placeholder="Номер паспорта" >' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Кем выдан</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="issued" class="form-control" placeholder="Кем выдан" >' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Дата выдачи</label>' +
        '                                            <div class="col-sm-9">' +
        '                                                <input type="text" modelAttribute="enterprise" name="issuedDate" class="form-control inpDate" placeholder="Дата выдачи" >' +
        '                                            </div>' +
        '                                        </div>' +
        '                                        <div class="form-group row">' +
        '                                            <label class="col-sm-3 col-form-label">Номер телефона</label>' +
